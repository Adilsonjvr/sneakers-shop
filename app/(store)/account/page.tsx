...
const mockOrders = [
  { id: 'DROP-239', model: 'AJ1 Retro High OG', status: 'Em preparação', date: '12 Out 2024' },
  { id: 'DROP-201', model: 'AJ4 Military Black', status: 'Entregue', date: '02 Set 2024' },
];
  ...
  return (
    <div className="space-y-8">
      <header className="glass-panel space-y-3 border border-white/10 bg-black/50 p-8">
        <p className="text-sm uppercase tracking-[0.4em] text-white/40">Área de colecionador</p>
        <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
          <div>
            <h1 className="font-display text-4xl font-semibold text-white">Conta & fidelidade</h1>
      ...
      {!isAuthenticated ? (
        <section className="rounded-3xl border border-white/10 bg-white/5 p-8">
          <p className="text-xs uppercase tracking-[0.4em] text-white/50">Entrar</p>
          <p className="mt-2 text-white/70">
            Este formulário é apenas ilustrativo. Nenhuma credencial é verificada durante o portfolio preview.
          </p>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6">
            <p className="text-xs uppercase tracking-[0.4em] text-white/50">Perfil</p>
            <h2 className="mt-3 text-2xl font-semibold text-white">Isabel Santos</h2>
            <p className="text-white/60">Membro desde 2018 · Lisboa</p>
            <div className="mt-4 grid grid-cols-2 gap-3 text-center text-white">
              <div className="rounded-2xl bg-black/30 p-3">
                <p className="text-xs uppercase tracking-[0.3em] text-white/50">Pares</p>
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6 lg:col-span-2">
            <p className="text-xs uppercase tracking-[0.4em] text-white/50">Pedidos recentes</p>
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6">
            <p className="text-xs uppercase tracking-[0.4em] text-white/50">Wishlist</p>
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6 lg:col-span-2">
            <p className="text-xs uppercase tracking-[0.4em] text-white/50">Preferências</p>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <label className="flex items-center gap-3 rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-sm text-white/70">
                <input type="checkbox" defaultChecked className="accent-brand" /> Alerts de drop exclusivos
              </label>
              <label className="flex items-center gap-3 rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-sm text-white/70">
                <input type="checkbox" className="accent-brand" /> Sugestões baseadas em heatmap
              </label>
              <label className="flex items-center gap-3 rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-sm text-white/70">
                <input type="checkbox" defaultChecked className="accent-brand" /> Newsletter colecionador
              </label>
              <label className="flex items-center gap-3 rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-sm text-white/70">
                <input type="checkbox" className="accent-brand" /> Partilhar atividade com amigos
              </label>
            </div>
          </section>
        </div>
